...
public class PageCriteria {
    private RecordCriteria rc;              //요청페이지, 요청페이지에 보여줄 레코드 수
    private final int PAGE_COUNT_PER_PAGE;  //요청페이지에 보여줄 페이지 수
    ...
    private boolean prev;                   //이전페이지 보여줄지 여부
    private boolean next;                   //다음페이지	보여줄지 여부
    ...
    private void calculatePaging() {
        //요청페이지의 시작페이지
        //(올림(요청페이지/요청페이지에 보여줄 페이지 수)-1) * 요청페이지에 보여줄 페이지 수+1
