...
function arrayType(requestUrl) {
    const URL = requestUrl === 'recentList' ? `/api/zonning/recentList`
                : requestUrl === 'discountListDesc' ? `/api/zonning/discountListDesc`
                : requestUrl === 'priceList' ? `/api/zonning/priceList`
                : requestUrl === 'priceListDesc' ? `/api/zonning/priceListDesc`
                : `doesn\'t exist`;
